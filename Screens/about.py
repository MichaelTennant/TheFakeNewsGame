"""
The about screen for the fake news game, imported by __main__.py
"""
...
class GUI():
    def __init__(self, parent):
        self.parent = parent
        self.parent.display.set_caption("The Fake News Game - About")
        ...
        self.title_text = self.title_font.render("About", True, pygame.Color(51,51,51))
